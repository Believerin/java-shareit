...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    @Query(value = "select new ru.practicum.shareit.booking.dto.BookingDto(" +
    ...
    Optional<BookingDto> findBooking(int userId, int bookingId);
    ...
    Optional<BookingDto> findBookingByOwner(int userId, int bookingId);
    ...
    @Query(value = "update bookings as b set status = case " +
            ...
            nativeQuery = true)
    void acceptBooking(int bookingId, boolean approved);
    ...
    @Query(value = "select new ru.practicum.shareit.booking.dto.BookingDto(" +
            ...
            "where " +
                ...
                "or (b.end > current_timestamp and b.start < current_timestamp and ?2 = 2) " + //b.status = 'APPROVED' and
    ...
    List<BookingDto> getAllBookingsByBookerOrOwner(int bookerOrOwnerId, int status, boolean isOwner);
}