DROP TABLE IF EXISTS users, items, bookings, requests, comments, item_offers  CASCADE;
...
CREATE TABLE IF NOT EXISTS item_offers (
    ...
    CONSTRAINT fk_item_offers_to_items FOREIGN KEY(item_id) REFERENCES items(id),
    CONSTRAINT fk_item_offers_to_requests FOREIGN KEY(request_id) REFERENCES requests(id));

CREATE TYPE STATE AS ENUM ('WAITING','APPROVED','REJECTED','CANCELLED');
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    item_id BIGINT,
    user_id BIGINT,
    status STATE('WAITING','APPROVED','REJECTED','CANCELLED'),
